...
const PropertyPage = async ({params}:{
    ...
    const addressLines = [property.address1, property.address2, property.city, property.state, property.postcode].filter(addressLine => !!addressLine)
                        ...
                        {property.images.map( (image, index) =>(
                            <CarouselItem key={image}>
                                <div className='relative h-[80vh] min-h-80'>
                                    <Image src={`https://firebasestorage.googleapis.com/v0/b/fir-homes.firebasestorage.app/o/${encodeURIComponent(
                        image
